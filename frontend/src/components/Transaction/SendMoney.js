...
const validationSchema = Yup.object().shape({
    ...
    receiverId: Yup.number('Id must be a number').positive('Invalid id').required('Id is required'),
})

const SendMoneyDialog = ({open, onClose, walletId}) => {
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12}>
                            <FormInput
                                label="Receiver Id"
                                name="receiverId"
                                isInputEmpty={values.receiverId}
                            />
                        </Grid>
                        <Grid item xs={12}>
                            <Button
